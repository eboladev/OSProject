...
**
** Created: Sat May 17 16:18:44 2014
...
static const char qt_meta_stringdata_OperatorDialog[] = {
    "OperatorDialog\0\0on_btn_add_clicked()\0"
    "on_btn_delete_clicked()\0on_btn_save_clicked()\0"
    "on_btn_cancel_clicked()\0"
    "on_tableView_role_clicked(QModelIndex)\0"
};
...
void OperatorDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->on_tableView_role_clicked((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData OperatorDialog::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject OperatorDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_OperatorDialog,
      qt_meta_data_OperatorDialog, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &OperatorDialog::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_OperatorDialog))
        return static_cast<void*>(const_cast< OperatorDialog*>(this));
